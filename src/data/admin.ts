...
export const customers: CustomerSummary[] = [
  ...
  },
  {
    ...
    city: { ar: "السليمانية", en: "Sulaymaniyah" },
    ordersCount: 2,
    totalSpent: 61000,
    joinedAt: "2026-02-05",
    status: "active",
...
export const adminReviews: AdminReview[] = [
  {
    ...
    rating: 5,
    title: { ar: "رواية لا تُنسى", en: "Unforgettable" },
    body: {
      ar: "أفضل ما قرأت هذا العام، والطبعة ممتازة.",
      en: "The best thing I read this year, and a great edition.",
    },
    createdAt: "2026-08-26",
    status: "pending",
  },
  {
    ...
    rating: 5,
    title: { ar: "لكل الأعمار", en: "For every age" },
    body: {
      ar: "اشتريته لابني وقرأته أنا مرتين.",
      en: "Bought it for my son and read it twice myself.",
    },
  ...
  },
  {
    id: "ar3",
    bookId: "b1",
    bookTitle: { ar: "موسم الهجرة إلى الشمال", en: "Season of Migration" },
    authorName: "علي كاظم",
    rating: 4,
    title: { ar: "كلاسيكية", en: "A classic" },
    body: {
      ar: "لغة عالية تحتاج قراءة متأنية.",
      en: "Dense prose that rewards slow reading.",
    },
  ...
  },
  {
    id: "ar4",
    bookId: "b27",
    bookTitle: { ar: "العادات السبع", en: "The 7 Habits" },
    authorName: "أحمد الربيعي",
    rating: 3,
    title: { ar: "مفيد لكنه مطوّل", en: "Useful but long" },
    body: {
      ar: "الأفكار جيدة والأمثلة مكرّرة.",
      en: "Good ideas, repetitive examples.",
    },
  ...
  },
  {
    id: "ar5",
    bookId: "b23",
    bookTitle: { ar: "الأعمال الشعرية الكاملة", en: "Collected Poems" },
    authorName: "ريم الخفاجي",
    rating: 5,
    title: { ar: "مجلد يستحق", en: "Worth the volume" },
    body: {
      ar: "الطباعة والورق بمستوى عالٍ.",
      en: "Printing and paper are top notch.",
    },
  ...
  },
  {
    ...
    authorName: "زائر",
    rating: 1,
    title: { ar: "رسالة إعلانية", en: "Spam" },
    body: {
      ar: "روابط دعائية غير متعلقة بالكتاب.",
      en: "Promotional links unrelated to the book.",
    },
  ...
  },
  {
    id: "ar7",
    bookId: "b12",
    bookTitle: { ar: "مئة عام من العزلة", en: "One Hundred Years of Solitude" },
    authorName: "يوسف الشمري",
    rating: 5,
    title: { ar: "ترجمة رائعة", en: "Excellent translation" },
    body: {
      ar: "قرأتها بترجمة أخرى سابقًا وهذه أفضل.",
      en: "I read another translation before; this one is better.",
    },
  ...
  },
  {
    ...
    rating: 4,
    title: { ar: "عمل ضخم", en: "A big work" },
    body: {
      ar: "يحتاج وقتًا لكنه يستحق.",
      en: "It takes time but it is worth it.",
    },
