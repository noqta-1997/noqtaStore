...
export function AdminSignOut({ locale, label }: AdminSignOutProps) {
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="inline-flex size-9 items-center justify-center border border-transparent text-on-surface transition-colors hover:border-line hover:bg-state-hover disabled:opacity-60"
    >
