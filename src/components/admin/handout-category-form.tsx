...
import { saveHandoutCategory } from "@/app/actions/admin";
...
interface HandoutCategoryFormProps {
  ...
  category?: HandoutCategoryNode;
  /** Pre-selects the parent when the form opens from a branch's "add under" link. */
  defaultParentId?: string;
}

/**
 * `CategoryForm` over the handouts' tree: one form for adding a handout
  ...
  return (
    ...
    >
      ...
      <Button type="submit" fullWidth>
        {isEdit ? t.save : admin.handoutCategories.add}
      </Button>
    </ActionForm>
  );
}
