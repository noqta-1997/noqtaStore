...
import { getHandoutBySlug } from "@/data";
import { readSlug } from "@/lib/slug";

/**
 * Decides "no such handout" before a byte of the page is sent.
 *
 ...
 */
export default async function HandoutLayout({
  params,
  children,
}: {
  ...
  if (!(await getHandoutBySlug(slug))) notFound();
