...
import { getHandoutCategoryBySlug } from "@/data";
import { readSlug } from "@/lib/slug";

/**
 * Decides "no such handout category" before a byte of the page is sent.
 *
 ...
 */
export default async function HandoutCategoryLayout({
  params,
  children,
}: {
  ...
  if (!(await getHandoutCategoryBySlug(slug))) notFound();
